            ...
            if func_name in ("Dataset", "Asset"):
                ...
                if node.targets and isinstance(node.targets[0], ast.Name):
                    ...
                    if node.value.args and isinstance(node.value.args[0], ast.Constant):
                        uri = str(node.value.args[0].value)
...
triggers:"""
    ...
    if analysis.assets:
        if include_comments:
            ...
            materialization_lines.append("# Exact Prefect asset APIs may vary by Prefect version.")
        ...
        for asset in analysis.assets:
            ...
            materialization_lines.append(
                "    # TODO: replace with your concrete Prefect asset API usage"
            )
